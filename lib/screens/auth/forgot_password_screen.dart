...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: theme.surf(context), elevation: 0,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Nhập email tài khoản. Chúng tôi sẽ gửi link đặt lại mật khẩu.',
                style: GoogleFonts.merriweather(
                    fontSize: 14, color: theme.sub(context), height: 1.6)),
            ...
            if (_sent)
              Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Text('Email đã được gửi. Kiểm tra hộp thư của bạn.',
                      style: GoogleFonts.roboto(color: const Color(0xFF059669), fontSize: 13))),
                ]),
              )
            else ...[
              if (auth.error != null)
